    ...
    private void ingresar(){
        ...
        if(A[hc]!=null){
            if(Integer.parseInt(A[hc].getNc())!=Integer.parseInt(txtNC.getText())){
                ...
                if(B[hc]!=null)
                    B[hc+1]=new Alumno(txtNC.getText(),txtNombre.getText(),Integer.parseInt(txtEdad.getText()),Integer.parseInt(txtCalificacion.getText()));
                else
                ...
                /*
                    Preguntar mañana:
                    No hay manera de evitar la redundancia definitivamente, si no se considera la cifra completa.
                
                    Si el NC tiene 8 digitos, entonces se debe reservar 99,999,999 espacios de memoria para evitar coliciones 
