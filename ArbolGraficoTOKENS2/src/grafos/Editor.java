...
public class Editor extends javax.swing.JFrame {
    ...
    private void mnuAnalizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuAnalizarActionPerformed
        // Analizar
        analizarOper(txtEditor.getText());
        
    }//GEN-LAST:event_mnuAnalizarActionPerformed

    private void analizar(String s){
        String[] palabras;
        palabras=s.split("");
        boolean valido=true;
        for (String palabra : palabras) {
            if(!Grafo.eside(palabra))
                valido=false;
        }
        showMessageDialog(null, "Es id: "+valido);
        
        
    }
    
    private void analizarOper(String s){
        //String[] palabras;
        //palabras=s.split("");
        boolean valido=Grafo.esoperacion(s);
        
        /*
        for (String palabra : palabras) {
            if(!Grafo.esoperacion(palabra))
                valido=false;
        }
        */
        showMessageDialog(null, "Es operacion: "+valido);
    }
    
    private boolean analizarExp(String exp){
        if(exp.contains("=")){
            String[] pre, pos, temp;
            ...
            showMessageDialog(null, "No es una expresion valida.");
